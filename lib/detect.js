...
// Lightroom Classic and Lightroom (CC) use different bundle ids, and the
// Classic one carries a version suffix that has moved between releases.
const CREATIVE = [
  {
    name: 'Lightroom',
    key: 'lightroom',
    apps: ['Adobe Lightroom Classic/Adobe Lightroom Classic.app', 'Adobe Lightroom CC/Adobe Lightroom CC.app'],
    bundles: ['com.adobe.LightroomClassicCC7', 'com.adobe.LightroomClassic', 'com.adobe.lightroomCC'],
  },
]
...
async function detect() {
  ...
  const lightroom = CREATIVE.find((c) => c.apps.some((a) => findApp(a))) ?? null
...
module.exports = { detect, TERMINALS, DICTATION, CREATIVE }
